...
After getting the latest code;

-Create a new branch. Git -> create a meaningful name.
-Then, do some changes and when we finish, we need to commit and push our changes to server(GitHub)
